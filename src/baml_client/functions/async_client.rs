...
baml_function_async!(ExtractInfo(input: impl AsRef<str> + BamlEncode, ) -> (stream_types::ExtractionResult, types::ExtractionResult));
...
impl BamlAsyncClient {
    ...
    pub fn with_options(&self, options: FunctionOptions) -> Self {
        Self {
            ...
            ExtractInfo: ExtractInfo { options: options.clone() },
