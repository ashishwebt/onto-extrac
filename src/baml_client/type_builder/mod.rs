...
impl TypeBuilder {
    ...
    /// Access the `ExtractionResult` class builder.
    pub fn ExtractionResult(&self) -> ExtractionResultClassBuilder {
        ExtractionResultClassBuilder::new(
            self.inner.get_class("ExtractionResult")
                .expect("class ExtractionResult is defined in schema")
        )
    }
