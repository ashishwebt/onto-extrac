...
/// Wrapper for the `ExtractionResult` class builder.
///
...
pub struct ExtractionResultClassBuilder {
    inner: ::baml::ClassBuilder,
}

impl ExtractionResultClassBuilder {
    ...
    pub fn r#type(&self) -> ::baml::TypeDef {
        self.inner.as_type()
            .expect("ExtractionResult is statically defined in .baml and should always have a type")
    }
    ...
    pub fn property_status(&self) -> ::baml::ClassPropertyBuilder {
        self.inner.get_property("status")
            .expect("ExtractionResult.status is statically defined in .baml and should always be present")
    }
